...
uint256 hashGenesisBlock("0x888515ca06fab94aec587ee3734217f7982039b800e490ed15760493ecf28bdc");
...
const string strMessageMagic = "nightnote Signed Message:\n";
...
{
    int64 nSubsidy = 0.389 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // nightnote: 1 days
static const int64 nTargetSpacing = 120; // nightnote: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nightnote miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "nightnote", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5c2b908bb1231659ec937a7c2f1e700aaaa0d82a61456fafcc2168b135bd8acb");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Where it all began";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387555876; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1638315;

        if (fTestNet)
        {
            block.nTime    = 1387550038;
            block.nNonce   = 2446112;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb96adac0748d558878e3e561c49c619f1a6f08fa9603a2f73aaecce180aa0615"));
